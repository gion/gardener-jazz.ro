...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom::</b></td><td>' . htmlentities($_REQUEST["custom_U2797"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom::</b></td><td>' . htmlentities($_REQUEST["custom_U2802"],ENT_COMPAT,'UTF-8') . '</td></tr>';
