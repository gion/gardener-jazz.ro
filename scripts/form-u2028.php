...
{
	$to = 'ALEXANDRU.BUTNARU@YAHOO.COM';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom::</b></td><td>' . htmlentities($_REQUEST["custom_U2029"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom::</b></td><td>' . htmlentities($_REQUEST["custom_U2034"],ENT_COMPAT,'UTF-8') . '</td></tr>';
